...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pg.image.load("./Image/jiniret.png")
        self.image = pg.transform.scale(
            self.image, (self.image.get_width() // 15, self.image.get_height() // 15)
        )
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("./Image/bokari.png")

        # scale the image down
        self.image = pg.transform.scale(
            self.image,
            (self.image.get_width() // 17, self.image.get_height() // 17)
        )
        self.rect = self.image.get_rect()
